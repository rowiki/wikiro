...
public class UAWikiGenerator {
    ...
    private void generateRegions() throws Exception {
        ...
        for (final Region eachReg : regions) {
            ...
            raionsFinished.addAll(Arrays.asList("Barîșivka", "Bohuslav",
                    "Borîspil", "Borodeanka", "Bila Țerkva", "Brovarî",
                    "Vasîlkiv", "Vîșhorod", "Volodarka"));
    ...
    private void generateRegionCategories(Region region) throws Exception {
        ...
        mainRegionCategory.append(regiuneRoName).append("|")
                .append(regiuneCategoryKey).append("]]");
